...
@section('content')
    <main>
        <div class="container-fluid px-4">
            <h5 class="mt-4">Pedido: {{ $pedido->taller }}</h5>
            <ol class="breadcrumb mb-4">
     
                <li class="breadcrumb-item active">Adicionar productos al pedido {{ $pedido->taller }}</li>
            </ol>
            ...
            <div class="card mb-1">
                <div class="card-body">
                    <div class="text-left mt-1">
                        ...
                        <a href="{{ url('/carritoaddfav/' . $id) }}" class="btn btn-warning ml-2 btn-sm"><i class="fa-solid fa-cart-plus"></i> Ver Carrito adición</a>
