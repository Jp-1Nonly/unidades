...
<main>
    <div class="container-fluid px-4">
        <h5 class="mt-4">Adición para el pedido favorito {{ $id }}</h5>
    ...
    <div class="card mb-1">
        <div class="card-body">
            <div class="text-left mt-1">
                ...
                <a href="{{ route('pedidos.adicionar', $id) }}" class="btn btn-danger btn-sm">Adicionar + Productos</a>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="card-datatable table-responsive">
                <form action="{{ route('carritoadd.update') }}" method="post">
                    @csrf
                    @method('PUT')
            ...
            <form id="procesarPedidoForm" action="{{ url('/procesar-pedidoadd') }}" method="post">
                @csrf
                <div class="mt-4">
