    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Editar datos de la visita</h3>
            </div>
            <div class="card-body">
                <div class="form">
                        ...
                        <div class="row align-items-start">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="motivo_visita" type="text" name="motivo_visita" placeholder="Ingrese motivo de la visita" value="{{ $visita['motivo_visita'] }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="vehiculo" type="tel" name="vehiculo" placeholder="Número de placa. Ej: ABC123" value="{{ $visita['vehiculo'] }}">
                                    </div>
                                </div>
                            </div>
                        </div>
